...
public class TopicGroupService {
	...
	public String getTopicGroups(String tenantId, String brand) {
		String result = null;
	...
	public String getTopicsForTopicGroup(String tenantId, String brand, String topicGroup) {
		String result = null;
		String query = " SELECT * from  " + tenantId + ".brand_topicgroup_map where brand='" + brand
	...
	public String getZScoreForTopics(String tenantId, String brand, String topicGroup, String topic, String fromDate,
		...
		try {
			...
			String query = " SELECT content_published_date day,ROUND((AVG(sourcedata_nps_score)-avgnps_table.tot_avg_nps)/avgnps_table.tot_std_nps,2) as z_score, "
					...
					+ " ( SELECT   content_published_date,AVG(sourcedata_nps_score) AS avg_nps FROM " + npsTable
